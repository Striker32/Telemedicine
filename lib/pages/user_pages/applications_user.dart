            ...
            children: const [
              ...
              ApplicationCard(
                ...
                physician: {
                  ...
                  'email': 'smirnova.ortho@example.com',
                  'city': 'Москва',
                  'experience': '10 лет',
                  'price': '6200',
                  'workplace': 'Ортодонтический центр «Правильный прикус»',
                  'about':
                  'Специализируется на установке брекет-систем и элайнеров. Имеет большой опыт работы с подростками и взрослыми пациентами. Применяет современные методы диагностики и цифрового моделирования прикуса. Акцентирует внимание на комфорте пациента и эстетике лечения. Регулярно проходит повышение квалификации и участвует в международных ортодонтических конференциях. Принимает в Москве.',
                }
